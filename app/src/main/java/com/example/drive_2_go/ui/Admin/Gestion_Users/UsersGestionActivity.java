...
public class UsersGestionActivity extends BaseAdminActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // CORRECTION : J'ai remplacé GestionUsersActivity.this par UsersGestionActivity.this
        adapter = new UserAdapter(UsersGestionActivity.this, userList);
...
// L'accolade de fermeture de onCreate() est maintenant ici, à la fin de la méthode.
    }

    // ***************************************************************
    // C'EST ICI QUE LA MÉTHODE loadUsers() DOIT ÊTRE DÉCLARÉE :
    // En tant que membre direct de la classe UsersGestionActivity.
    // ***************************************************************
    ...
    private void loadUsers() {
        db.collection("users")
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    ...
                    if (userList.isEmpty()) {
                        Toast.makeText(UsersGestionActivity.this, "Aucun utilisateur", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(e ->
                        Toast.makeText(UsersGestionActivity.this, "Erreur : " + e.getMessage(), Toast.LENGTH_SHORT).show());
    }
}
// L'accolade de fermeture de la classe est à la toute fin.*/